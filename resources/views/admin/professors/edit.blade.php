...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.professors.update', $professor->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name', $professor->name) }}" class="w-full border rounded-lg p-2 @error('name') border-red-500 @enderror" required>
            @error('name')
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="{{ old('email', $professor->email) }}" class="w-full border rounded-lg p-2 @error('email') border-red-500 @enderror" required>
            @error('email')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="position" value="{{ old('position', $professor->position) }}" class="w-full border rounded-lg p-2 @error('position') border-red-500 @enderror" required>
            @error('position')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="company" value="{{ old('company', $professor->company) }}" class="w-full border rounded-lg p-2 @error('company') border-red-500 @enderror">
            @error('company')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="work_experience_years" value="{{ old('work_experience_years', $professor->work_experience_years) }}" class="w-full border rounded-lg p-2 @error('work_experience_years') border-red-500 @enderror" min="0" max="60">
